...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_gameidle",category=['games'],prompt="I'm going to game for a bit",random=False,pool=True))

label monika_gameidle:
